...
insert into orders (id,order_number,username,
                    ...
                    status,comments, created_at) values
        (1, 'order-123', 'siva',
         'Siva', 'siva@gmail.com',
         '11111111', '123 Main St',
         'Apt 1', 'Dallas',
         'TX', '75001',
         'USA', 'NEW', null, '2025-09-30 20:18:59.640861'),

        (2, 'order-456', 'siva', 'Prasad', 'prasad@gmail.com',
         '2222222', '123 Main St', 'Apt 1',
         'Hyderabad', 'TS', '500072',
         'India', 'NEW', null, '2025-09-30 20:18:59.640861')
;
